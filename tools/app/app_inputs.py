...
def contract():
    ...
    paths.update(ROOT / p for p in ['upstream.lock.json', 'android-app/settings.gradle.kts',
    ...
    data = {'schemaVersion': 1, 'payload': pointer, 'runtimeBuildIdentity': identity(lock),
            ...
            'inputs': inputs, 'maturity': 'foreground-experiment; Android/background gates not passed'}
